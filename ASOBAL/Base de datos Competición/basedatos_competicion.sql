...
create table jugador (
    ...
    constraint chk_fecha_nacimiento_valida
        check (fecha_nacimiento is null or fecha_nacimiento <= curdate()),
    
    constraint chk_edad_minima
        check (fecha_nacimiento is null or datediff(curdate(), fecha_nacimiento) >= 5475),
...
create table partido (
    ...
    constraint chk_fecha_no_futura
        check (fecha <= date_add(curdate(), interval 1 year)),
